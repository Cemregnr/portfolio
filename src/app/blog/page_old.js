        ...
        <div className="lg:col-span-2">
          <div className="relative h-96 lg:h-[450px]">
            <div className="relative h-full w-full rounded-xl overflow-hidden">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/60 to-transparent rounded-xl"></div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <Link href="/">
          <div className="relative h-48 w-full rounded-xl overflow-hidden">
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/60 via-30% via-black/30 via-70% to-transparent rounded-xl"></div>
            <div className="absolute w-full bottom-0 p-3">
              <div className="flex items-center gap-1 mb-1">
                <div className="bg-green-500/80 p-1 rounded-full backdrop-blur-sm">
