        ...
        <div>
            <section className="lg:px-33 px-5 lg:my-30 my-10">
                <div className="relative mb-20">
                    ...
                    <p className="italic font-normal text-sm mt-2 text-gray-500">Explore comprehensive resources for English language learning and teaching.</p>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-7">
                    {articles?.map((article, index) => (
                        <div key={article.slug} className="border-2 border-[#2016736e] bg-[#0d0837] rounded-xl p-2 shadow-lg h-auto">
                            <Image 
                                width={300} 
                                height={320} 
                            ...
                            <div className="space-y-3 pt-5">
                                ...
                                <h1 className="text-2xl font-bold drop-shadow-lg text-white">{article?.title}</h1>
                            ...
                            <div className="flex items-center justify-between gap-4 font-semibold bg-indigo-900 p-2 rounded-xl mt-6">
                                ...
                                <Link href={`/articles/${article.slug}`} className="bg-indigo-400 text-[12px] font-bold px-4 py-2 rounded-xl border border-[#a4adff]">
